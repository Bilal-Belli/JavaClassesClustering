...
public class Exo2Qst2 {
    private Graph<String, DefaultWeightedEdge> graphCouplage;
    private float CP;

    // Constructor
    public Exo2Qst2(Graph<String, DefaultWeightedEdge> graphCouplage, float parametreCondition) {
    ...
    //public static void main(String[] args) {
        ...
        // Perform clustering
    	//Exo2Qst2 clustering = new Exo2Qst2(graphCouplage, 2f); // CP = 
